...
/*  5: em* at pci* dev -1 function -1 */
    {&em_ca,		&em_cd,		 0, STAR, loc+  0,    0, pv+ 3, 5, 0,    0},
/*  6: igb* at pci* dev -1 function -1 */
