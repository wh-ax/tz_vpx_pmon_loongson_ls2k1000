...
/*  3: pci* at pcibr0|ppb* bus -1 */
    {&pci_ca,		&pci_cd,	 0, STAR, loc+  1,    0, pv+ 0, 1, 0,    0},
/*  4: em* at pci* dev -1 function -1 */
    {&em_ca,		&em_cd,		 0, STAR, loc+  0,    0, pv+ 3, 5, 0,    0},
...
/*  8: ahci* at pci* dev -1 function -1 */
    {&ahci_ca,		&ahci_cd,	 0, STAR, loc+  0,    0, pv+ 3, 5, 0,    0},
/*  9: ahci_sd* at ahci* */
    {&ahci_sd_ca,	&ahci_sd_cd,	 0, STAR,     loc,    0, pv+ 9, 7, 0,    0},
/* 10: ahci_cdrom* at ahci* */
    {&ahci_cdrom_ca,	&ahci_cdrom_cd,	 0, STAR,     loc,    0, pv+ 9, 7, 0,    0},
/* 11: pcisyn0 at pci* dev -1 function -1 */
    {&pcisyn_ca,	&pcisyn_cd,	 0, NORM, loc+  0,    0, pv+ 3, 5, 0,    0},
/* 12: pcisyn1 at pci* dev -1 function -1 */
    {&pcisyn_ca,	&pcisyn_cd,	 1, NORM, loc+  0,    0, pv+ 3, 5, 0,    1},
/* 13: wd* at pciide* channel -1 drive -1 */
    {&wd_ca,		&wd_cd,		 0, STAR, loc+  0,    0, pv+ 5, 8, 0,    0},
/* 14: ide_cd* at pciide* channel -1 drive -1 */
    {&ide_cd_ca,	&ide_cd_cd,	 0, STAR, loc+  0,  0x1, pv+ 5, 8, 0,    0},
    {0},
    {0},
    {0},
    {0},
